    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="flex justify-between items-center mb-6 flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Link
            href="/demo"
            className="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded font-semibold text-sm"
          >
            📺 데모 보기
          </Link>
          <Link
          ...
          <Link
            href="/channels"
            className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 rounded font-semibold text-sm"
          >
            🏢 오피스 입장
          </Link>
          <LocaleSwitcher />
      ...
      {/* 💡 안내 배너 */}
      <div className="mb-6 p-4 bg-gray-800/60 border border-gray-700 rounded-lg text-sm text-gray-300 leading-relaxed">
        <p className="mb-1">
        ...
        <p>
          🏢 이미 캐릭터가 있다면, 카드를 클릭하거나 우측 상단{" "}
          <strong>오피스 입장</strong> 버튼으로 채널 목록으로 갑니다.
        </p>
      </div>
